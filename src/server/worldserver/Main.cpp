...
extern int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.worldserver", "----------------------------------------------------------------");
    TC_LOG_INFO("server.worldserver", "-                                                              -");
    TC_LOG_INFO("server.worldserver", "- TinyCore 3.3.5a Developered By Funwowserver.Com Support Team -");
    TC_LOG_INFO("server.worldserver", "-                                                              -");
    TC_LOG_INFO("server.worldserver", "- Website : www.tinycore.net                                   -");
    TC_LOG_INFO("server.worldserver", "- Email : lizard.tiny@gmail.com                                -");
    TC_LOG_INFO("server.worldserver", "-                                                              -");
    TC_LOG_INFO("server.worldserver", "----------------------------------------------------------------");
    TC_LOG_INFO("server.worldserver", "http://TinyCore.net \n");
