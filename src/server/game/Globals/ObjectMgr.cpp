 ...
 * Copyright (C) 2014 TrinityCore<http://trinitycore.org/>
 *
...
void ObjectMgr::LoadGossipMenuItemsLocales()
{
    ...
    do
    {
        ...
        uint16 menuId   = fields[0].GetInt32();
        uint16 id       = fields[1].GetInt32();
...
void ObjectMgr::LoadCreatureTemplate(Field* fields)
{
    ...
    creatureTemplate.minlevel         = fields[14].GetInt32();
    creatureTemplate.maxlevel         = fields[15].GetInt32();
    creatureTemplate.expansion        = uint32(fields[16].GetInt32());
    creatureTemplate.faction          = fields[17].GetInt32();
    ...
    creatureTemplate.rank             = fields[22].GetInt32();
    creatureTemplate.dmgschool        = uint32(fields[23].GetInt32());
    ...
    creatureTemplate.unit_class       = fields[28].GetInt32();
    ...
    creatureTemplate.family           = fields[32].GetInt32();
    creatureTemplate.trainer_type     = fields[33].GetInt32();
    creatureTemplate.trainer_spell    = fields[34].GetUInt32();
    creatureTemplate.trainer_class    = fields[35].GetInt32();
    creatureTemplate.trainer_race     = fields[36].GetInt32();
    creatureTemplate.type             = fields[37].GetInt32();
    ...
    for (uint8 i = SPELL_SCHOOL_HOLY; i < MAX_SPELL_SCHOOL; ++i)
        creatureTemplate.resistance[i] = fields[42 + i - 1].GetInt32();
    ...
    creatureTemplate.MovementType   = fields[61].GetInt32();
    creatureTemplate.InhabitType    = fields[62].GetInt32();
...
void ObjectMgr::LoadCreatureModelInfo()
{
    ...
    do
    {
        ...
        modelInfo.gender               = fields[3].GetInt32();
...
void ObjectMgr::LoadLinkedRespawn()
{
    ...
    do
    {
        ...
        uint8  linkType = fields[2].GetInt32();
...
void ObjectMgr::LoadTempSummons()
{
    ...
    do
    {
        ...
        SummonerType summonerType       = SummonerType(fields[1].GetInt32());
        uint8 group                     = fields[2].GetInt32();
        ...
        data.type                       = TempSummonType(fields[8].GetInt32());
...
void ObjectMgr::LoadCreatures()
{
    ...
    do
    {
        ...
        data.movementType   = fields[14].GetInt32();
        data.spawnMask      = fields[15].GetInt32();
...
void ObjectMgr::LoadGameobjects()
{
    ...
    do
    {
        ...
        data.animprogress   = fields[12].GetInt32();
        data.artKit         = 0;

        uint32 go_state     = fields[13].GetInt32();
        ...
        data.spawnMask      = fields[14].GetInt32();
...
void ObjectMgr::LoadItemTemplates()
{
    ...
    do
    {
        ...
        itemTemplate.Class                     = uint32(fields[1].GetInt32());
        itemTemplate.SubClass                  = uint32(fields[2].GetInt32());
        itemTemplate.SoundOverrideSubclass     = int32(fields[3].GetInt32());
        itemTemplate.Name1                     = fields[4].GetString();
        itemTemplate.DisplayInfoID             = fields[5].GetUInt32();
        itemTemplate.Quality                   = uint32(fields[6].GetInt32());
        itemTemplate.Flags                     = fields[7].GetUInt32();
        itemTemplate.Flags2                    = fields[8].GetUInt32();
        itemTemplate.BuyCount                  = uint32(fields[9].GetInt32());
        itemTemplate.BuyPrice                  = int32(fields[10].GetInt64());
        itemTemplate.SellPrice                 = fields[11].GetUInt32();
        itemTemplate.InventoryType             = uint32(fields[12].GetInt32());
        itemTemplate.AllowableClass            = fields[13].GetInt32();
        itemTemplate.AllowableRace             = fields[14].GetInt32();
        itemTemplate.ItemLevel                 = uint32(fields[15].GetInt32());
        itemTemplate.RequiredLevel             = uint32(fields[16].GetInt32());
        itemTemplate.RequiredSkill             = uint32(fields[17].GetInt32());
        itemTemplate.RequiredSkillRank         = uint32(fields[18].GetInt32());
        ...
        itemTemplate.RequiredReputationFaction = uint32(fields[22].GetInt32());
        itemTemplate.RequiredReputationRank    = uint32(fields[23].GetInt32());
        itemTemplate.MaxCount                  = fields[24].GetInt32();
        itemTemplate.Stackable                 = fields[25].GetInt32();
        itemTemplate.ContainerSlots            = uint32(fields[26].GetInt32());
        itemTemplate.StatsCount                = uint32(fields[27].GetInt32());

        for (uint8 i = 0; i < itemTemplate.StatsCount; ++i)
        {
            itemTemplate.ItemStat[i].ItemStatType  = uint32(fields[28 + i*2].GetInt32());
            itemTemplate.ItemStat[i].ItemStatValue = int32(fields[29 + i*2].GetInt32());
        }

        itemTemplate.ScalingStatDistribution = uint32(fields[48].GetInt32());
        ...
        for (uint8 i = 0; i < MAX_ITEM_PROTO_DAMAGES; ++i)
        {
            ...
            itemTemplate.Damage[i].DamageType = uint32(fields[52 + i*3].GetInt32());
        }

        itemTemplate.Armor          = uint32(fields[56].GetInt32());
        ...
        itemTemplate.Delay          = uint32(fields[63].GetInt32());
        itemTemplate.AmmoType       = uint32(fields[64].GetInt32());
        itemTemplate.RangedModRange = fields[65].GetFloat();

        for (uint8 i = 0; i < MAX_ITEM_PROTO_SPELLS; ++i)
        {
            itemTemplate.Spells[i].SpellId               = fields[66 + i*7  ].GetInt32();
            itemTemplate.Spells[i].SpellTrigger          = uint32(fields[67 + i*7].GetInt32());
            itemTemplate.Spells[i].SpellCharges          = int32(fields[68 + i*7].GetInt32());
            itemTemplate.Spells[i].SpellPPMRate          = fields[69 + i*7].GetFloat();
            itemTemplate.Spells[i].SpellCooldown         = fields[70 + i*7].GetInt32();
            itemTemplate.Spells[i].SpellCategory         = uint32(fields[71 + i*7].GetInt32());
            itemTemplate.Spells[i].SpellCategoryCooldown = fields[72 + i*7].GetInt32();
        }

        itemTemplate.Bonding        = uint32(fields[101].GetInt32());
        itemTemplate.Description    = fields[102].GetString();
        itemTemplate.PageText       = fields[103].GetUInt32();
        itemTemplate.LanguageID     = uint32(fields[104].GetInt32());
        itemTemplate.PageMaterial   = uint32(fields[105].GetInt32());
        ...
        itemTemplate.Sheath         = uint32(fields[109].GetInt32());
        ...
        itemTemplate.MaxDurability  = uint32(fields[114].GetInt32());
        itemTemplate.Area           = fields[115].GetUInt32();
        itemTemplate.Map            = uint32(fields[116].GetInt32());
        itemTemplate.BagFamily      = fields[117].GetUInt32();
        itemTemplate.TotemCategory  = fields[118].GetUInt32();

        for (uint8 i = 0; i < MAX_ITEM_PROTO_SOCKETS; ++i)
        {
            itemTemplate.Socket[i].Color   = uint32(fields[119 + i*2].GetInt32());
        ...
        itemTemplate.RequiredDisenchantSkill = uint32(fields[127].GetInt32());
        itemTemplate.ArmorDamageModifier     = fields[128].GetFloat();
        itemTemplate.Duration                = fields[129].GetUInt32();
        itemTemplate.ItemLimitCategory       = uint32(fields[130].GetInt32());
        ...
        itemTemplate.FoodType                = uint32(fields[134].GetInt32());
...
void ObjectMgr::LoadItemSetNames()
{
    ...
    do
    {
        ...
        uint32 invType = fields[2].GetInt32();
...
void ObjectMgr::LoadVehicleTemplateAccessories()
{
    ...
    do
    {
        ...
        int8   seatId       = fields[2].GetInt32();
        bool   isMinion     = fields[3].GetBool();
        uint8  summonType   = fields[4].GetInt32();
...
void ObjectMgr::LoadVehicleAccessories()
{
    ...
    do
    {
        ...
        int8   uiSeat       = int8(fields[2].GetInt32());
        bool   bMinion      = fields[3].GetBool();
        uint8  uiSummonType = fields[4].GetInt32();
...
void ObjectMgr::LoadPetLevelInfo()
{
    ...
    do
    {
        ...
        uint32 current_level = fields[1].GetInt32();
        ...
        pLevelInfo->health = fields[2].GetInt32();
        pLevelInfo->mana   = fields[3].GetInt32();
        pLevelInfo->armor  = fields[9].GetUInt32();

        for (int i = 0; i < MAX_STATS; i++)
        {
            pLevelInfo->stats[i] = fields[i+4].GetInt32();
        }
...
void ObjectMgr::LoadPlayerInfo()
{
    // Load playercreate
    {
        ...
        else
        {
            ...
            do
            {
                ...
                uint32 current_race  = fields[0].GetInt32();
                uint32 current_class = fields[1].GetInt32();
                uint32 mapId         = fields[2].GetInt32();
    ...
    TC_LOG_INFO("server.loading", "Loading Player Create Skill Data...");
    {
        ...
        else
        {
            ...
            do
            {
                ...
                skill.SkillId = fields[2].GetInt32();
                skill.Rank = fields[3].GetInt32();
        ...
        else
        {
            ...
            do
            {
                ...
                if (PlayerInfo* info = _playerInfo[current_race][current_class])
                    info->action.push_back(PlayerCreateInfoAction(fields[2].GetInt32(), fields[3].GetUInt32(), fields[4].GetInt32()));
    ...
    TC_LOG_INFO("server.loading", "Loading Player Create Level HP/Mana Data...");
    {
        ...
        do
        {
            ...
            uint32 current_class = fields[0].GetInt32();
            if (current_class >= MAX_CLASSES)
            {
            ...
            uint8 current_level = fields[1].GetInt32();      // Can't be > than STRONG_MAX_LEVEL (hardcoded level maximum) due to var type
            if (current_level > sWorld->getIntConfig(CONFIG_MAX_PLAYER_LEVEL))
            {
            ...
            levelInfo.basehealth = fields[2].GetInt32();
            levelInfo.basemana   = fields[3].GetInt32();
    ...
    TC_LOG_INFO("server.loading", "Loading Player Create Level Stats Data...");
    {
        ...
        do
        {
            ...
            uint32 current_level = fields[2].GetInt32();
            if (current_level > sWorld->getIntConfig(CONFIG_MAX_PLAYER_LEVEL))
            {
                if (current_level > STRONG_MAX_LEVEL)        // hardcoded level maximum
            ...
            if (PlayerInfo* info = _playerInfo[current_race][current_class])
            {
                ...
                for (int i = 0; i < MAX_STATS; i++)
                    levelInfo.stats[i] = fields[i + 3].GetInt32();
            }
    ...
    TC_LOG_INFO("server.loading", "Loading Player Create XP Data...");
    {
        ...
        do
        {
            ...
            uint32 current_level = fields[0].GetInt32();
...
void ObjectMgr::LoadInstanceTemplate()
{
    ...
    do
    {
        ...
        uint16 mapID = fields[0].GetInt32();
        ...
        instanceTemplate.Parent     = uint32(fields[1].GetInt32());
...
void ObjectMgr::LoadInstanceEncounters()
{
    ...
    do
    {
        Field* fields = result->Fetch();
        uint32 entry = fields[0].GetUInt32();
        uint8 creditType = fields[1].GetInt32();
        uint32 creditEntry = fields[2].GetUInt32();
        uint32 lastEncounterDungeon = fields[3].GetInt32();
...
void ObjectMgr::LoadGossipText()
{
    ...
    do
    {
        ...
        for (uint8 i = 0; i < MAX_GOSSIP_TEXT_OPTIONS; ++i)
        {
            ...
            gText.Options[i].Language         = fields[cic++].GetInt32();
            gText.Options[i].Probability      = fields[cic++].GetFloat();

            for (uint8 j = 0; j < MAX_GOSSIP_TEXT_EMOTES; ++j)
            {
                gText.Options[i].Emotes[j]._Delay = fields[cic++].GetInt32();
                gText.Options[i].Emotes[j]._Emote = fields[cic++].GetInt32();
            }
        }
...
void ObjectMgr::ReturnOrDeleteOldMails(bool serverUp)
{
    ...
    do
    {
        ...
        m->messageType    = fields[1].GetInt32();
        ...
        m->checked        = fields[7].GetInt32();
        m->mailTemplateId = fields[8].GetInt32();
...
void ObjectMgr::LoadAreaTriggerTeleports()
{
    ...
    do
    {
        ...
        at.target_mapId             = fields[1].GetInt32();
...
void ObjectMgr::LoadAccessRequirements()
{
    ...
    do
    {
        ...
        uint8 difficulty = fields[1].GetInt32();
        uint32 requirement_ID = MAKE_PAIR32(mapid, difficulty);

        AccessRequirement* ar = new AccessRequirement();

        ar->levelMin = fields[2].GetInt32();
        ar->levelMax = fields[3].GetInt32();
        ar->item_level = fields[4].GetInt32();
...
void ObjectMgr::LoadGameObjectTemplate()
{
    ...
    do
    {
        ...
        got.entry          = entry;
        got.type           = uint32(fields[1].GetInt32());
        ...
        got.faction        = uint32(fields[7].GetInt32());
...
void ObjectMgr::LoadCorpses()
{
    ...
    do
    {
        ...
        CorpseType type = CorpseType(fields[13].GetInt32());
...
void ObjectMgr::LoadReputationOnKill()
{
    ...
    do
    {
        ...
        repOnKill.RepFaction1          = fields[1].GetInt32();
        repOnKill.RepFaction2          = fields[2].GetInt32();
        repOnKill.IsTeamAward1        = fields[3].GetBool();
        repOnKill.ReputationMaxCap1  = fields[4].GetInt32();
        repOnKill.RepValue1            = fields[5].GetInt32();
        repOnKill.IsTeamAward2        = fields[6].GetBool();
        repOnKill.ReputationMaxCap2  = fields[7].GetInt32();
...
void ObjectMgr::LoadReputationSpilloverTemplate()
{
    ...
    do
    {
        ...
        uint32 factionId                = fields[0].GetInt32();

        RepSpilloverTemplate repTemplate;

        repTemplate.faction[0]          = fields[1].GetInt32();
        repTemplate.faction_rate[0]     = fields[2].GetFloat();
        repTemplate.faction_rank[0]     = fields[3].GetInt32();
        repTemplate.faction[1]          = fields[4].GetInt32();
        repTemplate.faction_rate[1]     = fields[5].GetFloat();
        repTemplate.faction_rank[1]     = fields[6].GetInt32();
        repTemplate.faction[2]          = fields[7].GetInt32();
        repTemplate.faction_rate[2]     = fields[8].GetFloat();
        repTemplate.faction_rank[2]     = fields[9].GetInt32();
        repTemplate.faction[3]          = fields[10].GetInt32();
        repTemplate.faction_rate[3]     = fields[11].GetFloat();
        repTemplate.faction_rank[3]     = fields[12].GetInt32();
...
void ObjectMgr::LoadNPCSpellClickSpells()
{
    ...
    do
    {
        ...
        uint8 userType = fields[3].GetInt32();
        ...
        uint8 castFlags = fields[2].GetInt32();
        SpellClickInfo info;
...
void ObjectMgr::LoadTrainerSpell()
{
    ...
    do
    {
        ...
        uint32 reqSkill      = fields[3].GetInt32();
        uint32 reqSkillValue = fields[4].GetInt32();
        uint32 reqLevel      = fields[5].GetInt32();
...
void ObjectMgr::LoadVendors()
{
    ...
    do
    {
        ...
        {
            uint32 maxcount     = fields[2].GetInt32();
...
void ObjectMgr::LoadGossipMenuItems()
{
    ...
    do
    {
        ...
        gMenuItem.MenuId                = fields[0].GetInt32();
        gMenuItem.OptionIndex           = fields[1].GetInt32();
        gMenuItem.OptionIcon            = fields[2].GetUInt32();
        gMenuItem.OptionText            = fields[3].GetString();
        gMenuItem.OptionBroadcastTextId = fields[4].GetUInt32();
        gMenuItem.OptionType            = fields[5].GetInt32();
...
void ObjectMgr::LoadCreatureClassLevelStats()
{
    ...
    do
    {
        ...
        {
            stats.BaseHealth[i] = fields[2 + i].GetInt32();
        ...
        stats.BaseMana = fields[5].GetInt32();
        stats.BaseArmor = fields[6].GetInt32();

        stats.AttackPower = fields[7].GetInt32();
        stats.RangedAttackPower = fields[8].GetInt32();
