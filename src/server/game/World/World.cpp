...
void World::LoadConfigSettings(bool reload)
{
	...
	rate_values[RATE_HONOR_VIP] = sConfigMgr->GetFloatDefault("Rate.Honor.VIP", 1.0f);
    ...
    m_bool_configs[CONFIG_AC_ACTION_LIST]                     = sConfigMgr->GetBoolDefault("TinyCore.Anticheat.Action", false);
    ...
    // 19
    // 20
    // Visit http://www.tinycore.net for forums and information
    //
    // End of prepatch
    ...
    m_bool_configs[CONFIG_ANTICHEAT_ENABLE] = sConfigMgr->GetBoolDefault("TinyCore.Anticheat.Enable", true);
    m_int_configs[CONFIG_ANTICHEAT_REPORTS_INGAME_NOTIFICATION] = sConfigMgr->GetIntDefault("TinyCore.Anticheat.ReportsForIngameWarnings", 70);
    m_int_configs[CONFIG_ANTICHEAT_DETECTIONS_ENABLED] = sConfigMgr->GetIntDefault("TinyCore.Anticheat.DetectionsEnabled",31);
    m_int_configs[CONFIG_ANTICHEAT_MAX_REPORTS_FOR_DAILY_REPORT] = sConfigMgr->GetIntDefault("TinyCore.Anticheat.MaxReportsForDailyReport",70);
	...
	m_int_configs[CONFIG_VIP_LOOT_RATE_LEVEL] = sConfigMgr->GetIntDefault("Rate.Loot.Vip", 1);
	...
	m_int_configs[CONFIG_INT_CHAT_PLAYED_TIME]  = sConfigMgr->GetIntDefault("MinTotalPlayedTimeForChat", 60);
