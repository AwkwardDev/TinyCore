...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "global",         rbac::RBAC_PERM_COMMAND_BAN,     true,  &HandleAntiCheatGlobalCommand,         "", NULL },
            { "player",         rbac::RBAC_PERM_COMMAND_BAN,     true,  &HandleAntiCheatPlayerCommand,         "", NULL },
            { "delete",         rbac::RBAC_PERM_COMMAND_BAN,  true,  &HandleAntiCheatDeleteCommand,         "", NULL },
            { "handle",         rbac::RBAC_PERM_COMMAND_BAN,  true,  &HandleAntiCheatHandleCommand,         "", NULL },
            { "jail",           rbac::RBAC_PERM_COMMAND_BAN,     true,  &HandleAnticheatJailCommand,         "", NULL },
            { "warn",           rbac::RBAC_PERM_COMMAND_BAN,     true,  &HandleAnticheatWarnCommand,         "", NULL },
            { NULL,             0,                     false, NULL,                                           "", NULL }
        };

        static ChatCommand commandTable[] =
        {
            { "anticheat",      rbac::RBAC_PERM_COMMAND_BAN,     true, NULL,                     "",  anticheatCommandTable},
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
